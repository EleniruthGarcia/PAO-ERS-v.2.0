...
export const formSchema = z.object({
	...
	contactNumber: z.string().regex(/^(?=\s*$)|(09|\+639)\d{9}$/, 'Invalid contact number!')
		.refine((value) => value !== '', { message: 'Contact number is required!' }),
	civilStatus: z.enum(['single', 'married', 'widowed', 'separated']),
	religion: z.string().max(50).optional(),
	citizenship: z.string().max(50),
	educationalAttainment: z.enum(Object.keys(educationalAttainment) as [EducationalAttainment, ...EducationalAttainment[]]),
	language: z.string().max(50),
	individualMonthlyIncome: z.number().optional(),
	detained: z.boolean(),
	detainedAt: z.string().max(100).optional(),
	detainedSince: z.date().or(z.literal('')).transform(e => e === '' ? undefined : e).optional(),
