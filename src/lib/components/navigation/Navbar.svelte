...
<header
	class="sticky top-0 z-50 w-full flex-none border-b border-border/40 bg-background/95 backdrop-blur [view-transition-name:navbar] supports-[backdrop-filter]:bg-background/60"
>
