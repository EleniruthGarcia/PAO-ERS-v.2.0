...
<aside
	class="min-h-[10%] fixed z-50 lg:static flex bottom-0 left-0 lg:flex-col items-center justify-evenly lg:justify-between lg:h-screen overflow-hidden bg-verdict w-full lg:w-auto lg:min-w-80 lg:items-start lg:p-10 lg:pt-14"
>
